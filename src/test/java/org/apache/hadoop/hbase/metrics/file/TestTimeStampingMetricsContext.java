...
public class TestTimeStampingMetricsContext {
  ...
  public void testFileUpdate() throws Exception {
    ...
    org.apache.hadoop.metrics.ContextFactory cf = org.apache.hadoop.metrics.ContextFactory.getFactory();
    ...
    assertEquals(" test1.testRecord: testTag1=testTagValue1, testTag2=testTagValue2, testMetric1=1, testMetric2=33\n", reminder);
  }
